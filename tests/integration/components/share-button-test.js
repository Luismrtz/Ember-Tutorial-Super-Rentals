...
module('Integration | Component | share-button', function (hooks) {
  ...
  test('it supports passing @text', async function (assert) {
    ...
    assert.strictEqualt(this.tweetParam('text'), 'Hello Twitter!');
  });
